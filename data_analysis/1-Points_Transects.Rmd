...
sample_systematic_points <- function(df, adjusted_sample_size, data_out){
  ...
  # Sample systematic points within a square grid
	...
	# Systematic point coordinates
	#systematic.points.coordinates <- tibble(
	#	Longitude = systematic.points.working.df$Systematic_Point_Longitude,
	#	Latitude = systematic.points.working.df$Systematic_Point_Latitude
	#	)
	
	# Check distances between points; want distance > 200 m
	#systematic.points.pairwise.distance.matrix <- distm(
	#	x = systematic.points.coordinates,
	#	fun = distGeo
	#	)
